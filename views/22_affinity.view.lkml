...
view: user_order_product {
  derived_table: {
    ...
    sql: SELECT
      ...
      FROM mazzero-looker.thelook.order_items oi
      LEFT JOIN mazzero-looker.thelook.inventory_items ii
        ON oi.inventory_item_id = ii.id
      LEFT JOIN mazzero-looker.thelook. products p
...
view: total_order_product {
  derived_table: {
    ...
    sql: SELECT
        ...
        , COUNT(*) AS prod_freq
      FROM mazzero-looker.thelook.order_items oi
      LEFT JOIN mazzero-looker.thelook.inventory_items
